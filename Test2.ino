...
const char* ssid     = "realme GT Neo2T";       // 连接WiFi名（此处使用taichi-maker为示例）
                                            // 请将您需要连接的WiFi名填入引号中
const char* password = "ps36ipb4";          // 连接WiFi密码（此处使用12345678为示例）
                                            // 请将您需要连接的WiFi密码填入引号中
...
// 心知天气HTTP请求所需信息
String reqUserKey = "SgvA6pV2Leh9lMQnP";   // 私钥
